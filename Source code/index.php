            	...
            	<div class="col-md-12 col-sm-12 col-xs-12">
                	<div class="product-main">
                        ...
                        <div class="title-product-main">
                           <h3 class="section-title"><a href="newproduct.php">Sản phẩm mới</a></h3>
                        </div>
                        <div class="content-product-main">
                            <div class="row">
                                <?php
                                    $sql = "SELECT id,image,name,price FROM products WHERE category_id=3 LIMIT 4";
                                    $result = mysqli_query($conn,$sql);
                       ...
                       <!-- Thời Trang Nam -->
                            <div class="title-product-main">
                              <h3 class="section-title"><a href="fashionboy.php">Thời Trang Nam</a></h3>
                            </div>
                        <div class="content-product-main">
                            <div class="row">
                                <?php
                                    $sql = "SELECT id,image,name,price FROM products WHERE category_id=1 LIMIT 4";
                                    $result = mysqli_query($conn,$sql);
                      ...
                      <!-- Thời Trang Nữ -->
                        <div class="title-product-main">
                             <h3 class="section-title"><a href="fashiongirl.php">Thời Trang Nữ</a></h3>
                        </div>
                        <div class="content-product-main">
                            <div class="row">
                                <?php
                                    $sql = "SELECT id,image,name,price FROM products WHERE category_id=2 LIMIT 4";
                                    $result = mysqli_query($conn,$sql);
